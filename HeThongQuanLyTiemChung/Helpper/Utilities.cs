...
namespace HeThongQuanLyTiemChung.Helpper
{
    public class Utilities
    {
        ...
        public static Int32 GetMonth(DateTime dateOfBirth)
        {
            ...
            {
                int sonam = today.Year - dateOfBirth.Year;
                if (dateOfBirth.Month > today.Month)
                {
                    if (today.Day >= dateOfBirth.Day)
                    {
                        sothang = (sonam * 12) - dateOfBirth.Month + today.Month;
                    }
                    else
                    {
                        sothang = (sonam * 12) - dateOfBirth.Month + today.Month - 1;
                    }
                ...
                else
                {
                    if (today.Day >= dateOfBirth.Day)
                    {
                        sothang = (sonam * 12) + (today.Month - dateOfBirth.Month);
                    }
                    else
                    {
                        sothang = (sonam * 12) + (today.Month - dateOfBirth.Month) - 1;
                    }
            ...
            else
            {
                if (dateOfBirth.Month > today.Month)
                {
                    if (today.Day >= dateOfBirth.Day)
                    {
                        sothang = (12 - dateOfBirth.Month + today.Month - 1) + 1;
                    }
                    else
                    {
                        sothang = (12 - dateOfBirth.Month + today.Month - 1) - 1;
                ...
                else
                {
                    if (today.Day >= dateOfBirth.Day)
                    {
                        sothang = (today.Month - dateOfBirth.Month);
                    }
                    else
                    {
                        sothang = (today.Month - dateOfBirth.Month) - 1;
                    }
        ...
        public static string GetMonthOfAge(int month)
        {
            string thangtuoi;
            ...
            else
            {
                if (month / 12 == 0)
                {
                    thangtuoi = month % 12 + " tháng";
                    return thangtuoi;
                }
                else
                {
                    int thang = month % 12;
                    thangtuoi = month / 12 + " tuổi " + thang + " tháng";
                    return thangtuoi;
                }                  
            }
